...
<p align="center">
  <a href="https://github.com/my-ai-stack/stack-3.0">
    <img src="https://img.shields.io/github/stars/my-ai-stack/stack-3.0?style=flat-square" alt="GitHub stars"/>
  </a>
  <a href="https://github.com/my-ai-stack/stack-3.0/blob/main/LICENSE">
...
# Stack 3.0 - AI Agent Framework with 72 Premium Tools 🔧

> **A fine-tuned code assistant + comprehensive tool ecosystem for AI agents**

Stack 3.0 is a code generation model fine-tuned from Qwen2.5-Coder-1.5B, paired with **72 production-ready tools** for building AI agents, multi-agent teams, and autonomous workflows.
...
Stack 3.0 is more than just a code generator; it is an intelligent agent equipped with a suite of cognitive enhancements:
...
model = AutoModelForCausalLM.from_pretrained(
    "my-ai-stack/Stack-3-0-Pro",
    torch_dtype="auto",
    device_map="auto"
)
tokenizer = AutoTokenizer.from_pretrained("my-ai-stack/Stack-3-0-Pro")
```
...
print(registry.list())  # List all 72 tools
...
- [GitHub Repository](https://github.com/my-ai-stack/stack-3.0)
- [HuggingFace Space (Demo)](https://huggingface.co/spaces/my-ai-stack/stack-3-0-demo)
...
```bibtex
@misc{my-ai-stack/stack-3-0-pro,
  author = {Walid Sobhi},
  title = {Stack 3.0: Fine-tuned Qwen2.5-Coder-1.5B with 72 Agent Tools},
  year = {2026},
  publisher = {HuggingFace},
  url = {https://huggingface.co/my-ai-stack/Stack-3-0-Pro}
}
```
...
<p align="center">
  ...
  <a href="https://discord.gg/clawd">Discord</a> · <a href="https://github.com/my-ai-stack/stack-3.0">GitHub</a> · <a href="https://huggingface.co/my-ai-stack">HuggingFace</a>
</p>
